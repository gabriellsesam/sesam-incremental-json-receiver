...
| UPDATED_PROPERTY_FROM_FORMAT | Parses the date field in source entities with [python datetime syntax](https://docs.python.org/3/library/datetime.html#strftime-and-strptime-behavior). | no | n/a |
